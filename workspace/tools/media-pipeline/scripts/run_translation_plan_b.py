...
NORMALIZE = ROOT / 'normalize_input_plan_b.py'
TRANSLATE = ROOT / 'translate_segments_plan_b.py'
...
def main():
    p = argparse.ArgumentParser(description='Unified normalize -> translate -> emit pipeline (plan B)')
